import {
  sectionContainer,
  textContainer,
} from './styles/LegalPages.module.css';
    ...
    <div className="imageHeroeContainer">
      ...
      >
        ...
        >
          ...
          <h3>CUENTAS</h3>
          <p>Al registrarse en el Servicio, aceptas proporcionar información precisa, completa y actualizada sobre tu cuenta de usuario. Es responsabilidad del usuario mantener la confidencialidad de su cuenta y contraseña, así como restringir el acceso a su computadora y dispositivos. Aceptas la responsabilidad de todas las actividades que ocurran bajo tu cuenta o contraseña.</p>
          <h3>USO DEL SERVICIO</h3>
          <p>El Servicio permite la compra de productos y/o servicios disponibles. Aceptas utilizar el Servicio solo para fines legales y de acuerdo con estos Términos y te comprometes a no utilizar el Servicio con fines ilegales o no autorizados.</p>
          ...
          <h3>CAMBIOS</h3>
          <p>Nos reservamos el derecho, a nuestra sola discreción, de modificar o reemplazar estos Términos en cualquier momento. Si una revisión es necesaria, intentaremos proporcionar un aviso de al menos 30 días antes de que los nuevos términos entren en vigencia. Lo que constituye un cambio neesario se determinará a nuestra sola discreción.</p>
          <p>Al navegar en este sitio web aceptas de manera expresa los términos aquí presentados.</p>
        </div>
      </section>
    </div>
  );
